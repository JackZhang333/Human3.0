        ...
        <div className="relative z-10 w-full max-w-md">
            <div className="glass p-8 rounded-2xl">
                ...
                <p className="text-[var(--text-secondary)] text-center mb-8">
                    {mode === 'login' ? '登录以继续你的发展评估' : '开始你的 Human 3.0 之旅'}
                </p>
                ...
                >
                    ...
                    使用 Google 账户{mode === 'login' ? '登录' : '注册'}
                </button>

                <div className="flex items-center gap-4 mb-6">
                    <div className="flex-1 h-px bg-[var(--border)]" />
                    <span className="text-sm text-[var(--text-muted)]">或使用邮箱</span>
                    <div className="flex-1 h-px bg-[var(--border)]" />
                </div>
...
export default function LoginPage() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
            ...
            <Suspense fallback={<div className="glass p-8 rounded-2xl w-full max-w-md text-center">加载中...</div>}>
                <LoginForm />
            </Suspense>
        </div>
    );
